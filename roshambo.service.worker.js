...
/** @type {string} */
const CACHE_VERSION = '1751906310|241926951';
/** @type {string} */
const CACHE_PREFIX = 'Ro Shambo: Dunge-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'roshambo.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["roshambo.html","roshambo.js","roshambo.offline.html","roshambo.icon.png","roshambo.apple-touch-icon.png","roshambo.audio.worklet.js","roshambo.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["roshambo.wasm","roshambo.pck"];
